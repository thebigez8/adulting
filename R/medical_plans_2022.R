fsahsahelp <- overlay(
  ...
  "$2750 in 2020 to an FSA (so that if you're on a family plan, you're stuck at $2750). On ",
  "the flip side, if you're on a single-coverage HDHP, you can contribute $3650 ",
  "in 2022 to an HSA, and $7300 if you have family coverage. Finally, note that ",
...
html(
  ...
  HTMLhead(
    titl = "Medical Plan Comparison 2022",
    js = c("toggle", "overlay", "medical_plans_2020", "medical_plans_2022", "medical_plans_plot_2020"),
  ...
  body(
    ...
    h2("Medical Plan Comparison 2022"),
    div(
      class="row",
      div(
          ...
          tbody(
            ...
            tr(
              ...
              td(
                ...
                input(type="number", id="fsahsa1", value=2750, step=1, min=0, max=2750)
              ),
              td(
                label(`for`="fsahsa2", "FSA"),
                input(type="number", id="fsahsa2", value=2750, step=1, min=0, max=2750)
              ),
              td(
                label(`for`="fsahsa3", "HSA"),
                input(type="number", id="fsahsa3", value=7300, step=1, min=0, max=7300)
              )
            ),
            ...
            tr(
              ...
              td(input(type="number", id="rollover3", value=7300, step=1, min=0, style = "display:none"))
            )
          ),
          tbody(
            id = "expenses",
  ...
  write2file(file = "docs/finance/medical_plans_2022.html")
